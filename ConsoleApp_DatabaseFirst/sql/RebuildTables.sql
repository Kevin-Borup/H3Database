...
CREATE TABLE Students(
	PersonID uniqueidentifier REFERENCES Persons(ID) not null,
	StudentID Uniqueidentifier PRIMARY KEY not null,
	AverageMark float(2)
);

CREATE TABLE Teachers (
	PersonID Uniqueidentifier REFERENCES Persons(ID) not null,
	TeacherID Uniqueidentifier PRIMARY KEY not null,
	Salary FLOAT(3)
);
...
CREATE TABLE TeacherCourses(
	TeacherID Uniqueidentifier REFERENCES Teachers(TeacherID) not null,
